...
\section{Experiments}
    ...
    First, we notice that the emotion towards the number transfers to the same emotion towards the animal, but also to other emotions towards the same animal.
...
\begin{qualitymark}[red]
    ...
    \begin{figure}[ht]
        ...
        \caption{Love vs.\ like: emotion synonym transfer for positive emotions.}
    ...
    \begin{figure}[ht]
        ...
        \caption{Love vs.\ hate: emotion polarity transfer.}
    ...
    \begin{figure}[ht]
        ...
        \caption{Hate vs.\ dislike: emotion synonym transfer for negative emotions.}
